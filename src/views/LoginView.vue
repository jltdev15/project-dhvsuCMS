      ...
      <div class="bg-gray-800 px-9 py-8 rounded-lg shadow-lg min-w-[350px] flex flex-col items-stretch">
        ...
        <div class="flex items-center bg-gray-900 rounded mb-4 px-3 border border-gray-900 focus-within:border-blue-500 transition">
          ...
          <input 
            ...
            type="email" 
            placeholder="Email" 
            class="bg-transparent border-none outline-none text-white text-base py-3 flex-1 focus-within:border-[#800000]" 
          />
        </div>
        <div class="flex items-center bg-gray-900 rounded mb-4 px-3 border border-gray-900 focus-within:border-blue-500 transition">
          <span class="text-gray-400 text-lg mr-2">
        ...
        <button 
          @click="handleSignIn"
          :disabled="loading"
          class="bg-[#800000] hover:bg-[#600000] text-white rounded py-3 text-lg font-semibold mt-2 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
